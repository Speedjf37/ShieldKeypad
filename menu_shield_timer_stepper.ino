  ...
  char buffercar[17];
    ...
    if (Menu_Rang == MENU_NO )  // Si pas de menu en cours
      ...
      if ( (TimerState == 1)&&(TimerState_old  == 0))//start
       ...
       if( (TimerState ==1)&&(TimerState_old  ==2 )) //fin Pause Restart
        {
        MyStepper.SetAccel(memory.d.mot_accel);
        VitesseMot=memory.d.mot_vit;
        MyStepper.SetSpeed(VitesseMot);
      ...
      if (( (TimerState == 0)&&(TimerState_old  != 0))||( (TimerState ==2)&&(TimerState_old  ==1)) )//stop ou pause
        {
        //ARRET du moteur
        #ifdef MENU_NO_print
      ...
      if (TimerState != aff_TimerState)
       ...
       if ( new_sec != aff_sec)
        ...
        if (VitesseMot != aff_VitesseMot)
          ...
          lcd.print("      ");
          lcd.setCursor(5,1);
          lcd.print((VitesseMot/memory.d.mot_pas)*60);//tr/mn memory.d.mot_vit step/s
